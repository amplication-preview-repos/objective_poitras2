...
export class ResponseResolverBase {
  ...
  async createResponse(
    ...
    return await this.service.createResponse({
      ...
      data: {
        ...
        voiceCommand: args.data.voiceCommand
          ? {
              connect: args.data.voiceCommand,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => VoiceCommand, {
    nullable: true,
    name: "voiceCommand",
  })
  async getVoiceCommand(
    ...
    const result = await this.service.getVoiceCommand(parent.id);
