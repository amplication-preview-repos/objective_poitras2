...
@InputType()
class VoiceCommandCreateNestedManyWithoutUsersInput {
...
export { VoiceCommandCreateNestedManyWithoutUsersInput as VoiceCommandCreateNestedManyWithoutUsersInput };
