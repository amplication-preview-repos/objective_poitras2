...
@InputType()
class ResponseCreateNestedManyWithoutVoiceCommandsInput {
...
export { ResponseCreateNestedManyWithoutVoiceCommandsInput as ResponseCreateNestedManyWithoutVoiceCommandsInput };
