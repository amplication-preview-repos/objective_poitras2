...
class VoiceCommandCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ResponseCreateNestedManyWithoutVoiceCommandsInput,
  })
  @ValidateNested()
  @Type(() => ResponseCreateNestedManyWithoutVoiceCommandsInput)
  @IsOptional()
  @Field(() => ResponseCreateNestedManyWithoutVoiceCommandsInput, {
    nullable: true,
  })
  responses?: ResponseCreateNestedManyWithoutVoiceCommandsInput;
}

export { VoiceCommandCreateInput as VoiceCommandCreateInput };
