...
@InputType()
class VoiceCommandCreateNestedManyWithoutDevicesInput {
...
export { VoiceCommandCreateNestedManyWithoutDevicesInput as VoiceCommandCreateNestedManyWithoutDevicesInput };
